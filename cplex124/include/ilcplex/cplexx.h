...
CPX_STATIC_INLINE CPXDEPRECATED CPXVOIDptr CPXPUBLIC
...
CPX_STATIC_INLINE CPXDEPRECATED void CPXPUBLIC
   CPXXfree (void *ptr) {
CPX_CALL (free) (ptr);
   }

CPX_STATIC_INLINE CPXDEPRECATED size_t CPXPUBLIC
   CPXXstrlen (const char *s_str) {
      return CPX_CALL (strlen) (s_str);
   }

CPX_STATIC_INLINE CPXDEPRECATED CPXCHARptr CPXPUBLIC
