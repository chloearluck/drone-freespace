...
create_test_example: create_test_example.o simplify.o expander2.o io.o polyhedron.o triangulate.o object.o acp.o hull.o
	$(LINK) create_test_example.o simplify.o expander2.o io.o polyhedron.o triangulate.o object.o acp.o hull.o $(LFLAGS) -o create_test_example
