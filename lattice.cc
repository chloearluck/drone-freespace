...
const double pole_width = 1e-3;
const double width = 6.5, height = 2.5, depth = 3.0; //lattice dimensions
const double delta_h = 1.5;

const double r = 0.85; //radius of robot
const double a = 1e-3; //width of each of the robots arms
...
int main (int argc, char *argv[]) {
  ...
  if (argc == 2) { 
    ...
    if (CONSTRUCT_ROOM) {
        ...
        //top ramp
        PTR<Point> p0 = new Point(-width/2-ww/2, -depth/2-ww/2, height/2+ww/2);
        PTR<Point> p1 = new Point(-width/2-ww/2,  depth/2+ww/2, height/2+ww/2);
        PTR<Point> p2 = new Point( width/2+ww/2, -depth/2-ww/2, height/2+ww/2);
        PTR<Point> p3 = new Point( width/2+ww/2,  depth/2+ww/2, height/2+ww/2);
        PTR<Point> p4 = new Point(-width/2-ww/2, -depth/2-ww/2, height/2-delta_h);
        PTR<Point> p5 = new Point(-width/2-ww/2,  depth/2+ww/2, height/2-delta_h);
        Points points; 
        points.push_back(p0); points.push_back(p1); points.push_back(p2); 
        points.push_back(p3); points.push_back(p4); points.push_back(p5); 
        Polyhedron * ramp = convexHull(points);
        //bottom ramp
        p0 = new Point(-width/2-ww/2, -depth/2-ww/2, -height/2-ww/2);
        p1 = new Point(-width/2-ww/2,  depth/2+ww/2, -height/2-ww/2);
        p2 = new Point( width/2+ww/2, -depth/2-ww/2, -height/2-ww/2);
        p3 = new Point( width/2+ww/2,  depth/2+ww/2, -height/2-ww/2);
        p4 = new Point( width/2+ww/2, -depth/2-ww/2, -height/2+delta_h);
        p5 = new Point( width/2+ww/2,  depth/2+ww/2, -height/2+delta_h);
        points.clear(); 
        points.push_back(p0); points.push_back(p1); points.push_back(p2); 
        points.push_back(p3); points.push_back(p4); points.push_back(p5); 
        Polyhedron * ramp2 = convexHull(points);
  ...
  if (CONSTRUCT_ROBOT) {
    ...
    double h = 0.2;//height for plus, set to a for jack

    PTR<Point>  a0 = new Point(-a,-a, r);
    PTR<Point>  a1 = new Point(-a, a, r);
    PTR<Point>  a2 = new Point( a,-a, r);
    PTR<Point>  a3 = new Point( a, a, r);
    PTR<Point>  b0 = new Point(-a,-a, h);
    PTR<Point>  b1 = new Point(-a, a, h);
    PTR<Point>  b2 = new Point( a,-a, h);
    PTR<Point>  b3 = new Point( a, a, h);
    PTR<Point>  c0 = new Point(-a,-a,-h);
    PTR<Point>  c1 = new Point(-a, a,-h);
    PTR<Point>  c2 = new Point( a,-a,-h);
    PTR<Point>  c3 = new Point( a, a,-h);
    PTR<Point>  d0 = new Point(-a,-a,-r);
    PTR<Point>  d1 = new Point(-a, a,-r);
    PTR<Point>  d2 = new Point( a,-a,-r);
    PTR<Point>  d3 = new Point( a, a,-r);
    PTR<Point> bl0 = new Point(-r,-a, h);
    PTR<Point> bl1 = new Point(-r, a, h);
    PTR<Point> cl0 = new Point(-r,-a,-h);
    PTR<Point> cl1 = new Point(-r, a,-h);
    PTR<Point> br2 = new Point( r,-a, h);
    PTR<Point> br3 = new Point( r, a, h);
    PTR<Point> cr2 = new Point( r,-a,-h);
    PTR<Point> cr3 = new Point( r, a,-h);
    PTR<Point> bb0 = new Point(-a,-r, h);
    PTR<Point> bb2 = new Point( a,-r, h);
    PTR<Point> cb0 = new Point(-a,-r,-h);
    PTR<Point> cb2 = new Point( a,-r,-h);
    PTR<Point> bf1 = new Point(-a, r, h);
    PTR<Point> bf3 = new Point( a, r, h);
    PTR<Point> cf1 = new Point(-a, r,-h);
    PTR<Point> cf3 = new Point( a, r,-h);
    ...
    Polyhedron * left = convexHull(points);
    points.clear();
    ...
    Polyhedron * right = convexHull(points);
    points.clear();
    ...
    Polyhedron * back = convexHull(points);
    points.clear();
    ...
    Polyhedron * front = convexHull(points);
